...
from part1 import valor_min_VELOCIDADE, valor_max_VELOCIDADE
...
'''
    Definindo matematicamente 'aperta_freio': 
...
'''
    Definindo matematicamente 'libera_freio': 
